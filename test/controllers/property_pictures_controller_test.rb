...
class PropertyPicturesControllerTest < ActionController::TestCase
  ...
  test "should create property_picture" do
    assert_difference('PropertyPicture.count') do
      post :create, property_picture: { name: @property_picture.name, property_id: @property_picture.property_id, url: @property_picture.url }
    end
  ...
  test "should update property_picture" do
    patch :update, id: @property_picture, property_picture: { name: @property_picture.name, property_id: @property_picture.property_id, url: @property_picture.url }
    assert_redirected_to property_picture_path(assigns(:property_picture))
  end
